...
{                 
    ...
    DelayMs(20);    	//À­µÍÖÁÉÙ18ms
    DHT11_DQ_OUT=1; 	//DQ=1 
		DelayUs(30);     	//Ö÷»úÀ­¸ß20~40us
}
//µÈ´ýDHT11µÄ»ØÓ¦
//·µ»Ø1:Î´¼ì²âµ½DHT11µÄ´æÔÚ
//·µ»Ø0:´æÔ8 DHT11_Check(void) 	   
u8 DHT11_Check(void) 	   	
{   
	u8 retry=0;
...
{	 
 	...
 	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC, ENABLE);	 //Ê¹ÄÜPG¶Ë¿ÚÊ±ÖÓ
	
 	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13;				 //PG11¶Ë¿ÚÅäÖÃ
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //ÍÆÍìÊä³ö
 	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
 	GPIO_Init(GPIOC, &GPIO_InitStructure);				 //³õÊ¼»¯IO¿Ú
 	GPIO_SetBits(GPIOC,GPIO_Pin_13);						 //PG11 Êä³ö¸ß
