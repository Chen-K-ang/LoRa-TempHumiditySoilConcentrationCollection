...
/******************************************************************************
      ...
      返回值：  无
******************************************************************************/
void LCD_ShowPicture(u16 x1,u16 y1,u16 x2,u16 y2,u8 img)
{
	u16 i,num;
	u8 *image=NULL;
	switch(img)
	{
		case(0):image=(u8 *)(icon_image[0]);break;
		case(1):image=(u8 *)(icon_image[1]);break;
		case(2):image=(u8 *)(icon_image[2]);break;
		case(3):image=(u8 *)(icon_image[3]);break;
		case(4):image=(u8 *)(title_image);break;
		default:image=(u8 *)(icon_image[0]);break;
	}
	num = (x2-x1+1)*(y2-y1+1);
