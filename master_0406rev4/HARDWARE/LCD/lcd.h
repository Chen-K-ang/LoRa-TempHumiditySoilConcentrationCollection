...
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_6)//SCL
...
#define OLED_BLK_Clr()  GPIO_ResetBits(GPIOC,GPIO_Pin_10)//BLK
#define OLED_BLK_Set()  GPIO_SetBits(GPIOC,GPIO_Pin_10)

#define OLED_CMD  0	//写命令
#define OLED_DATA 1	//写数据

extern  u16 BACK_COLOR;   //背景色
extern u16 POINT_COLOR;	//画笔色
